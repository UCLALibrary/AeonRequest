...
public class VgerBibDataGenerator
  extends BaseGenerator
{
  ...
  public VgerBibData getBibData()
  {
    ...
    bibData = ( VgerBibData ) new JdbcTemplate( ds ).queryForObject( BIB_QUERY, new Object[]
    ...
    itemGen.setUrl( bibData.getOacUrl() );
  ...
  public VgerBibData getXmlBibData()
  {
    VgerItemDataGenerator itemGen;
