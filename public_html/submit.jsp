...
<html lang="en">
    ...
    <body class="d-flex flex-column">
        ...
        <main class="container my-5 flex-grow-1">
            ...
            <form id="AeonRequest" name="AeonRequest" target="_self" method="post"
                  action="https://speccoll.library.ucla.edu/logon" class="mt-5">
                                ...
                                <c:forEach var="srlf" items="${bibRecord.srlfItems}">
                                    ...
                                    <div class="t-row">
                                        <div class="t-cell py-1 px-3 column-2">
                                            ...
                                            <input value="${param.bibID}" name="ReferenceNumber_${index}"
                                                   type="hidden"/>
