...
<html>
  ...
  <body bgcolor="#FFFFFF" topmargin="0" marginheight="0" marginwidth="0" leftmargin="0" width="960">
    ...
    <table align="center" width="960" border="1" class="footer">
      <tr>
        <td>
          You have successfully logged out of the Aeon system.<br/><br/>
          However, you may have active sessions at other sites you've visited 
          while signed in. If you are using a public or shared workstation, 
          <b>shut down your browsers to make sure you have signed out of all 
          applications</b>.
        </td>
      </tr>
    </table>
